...
import "../public/styles/mejorViaje.css"
function MejorViaje() {
    return (
        <div className="backgroundImage">
            <div className="elements">
                ...
                <div className="rowsDownPart">
                    <div><h2>942<br/>Excursiones</h2></div>
                    <div><h2>1746<br/>Clientes<br/> Satisfechos</h2></div>
                </div>
            </div>
        </div>
