        ...
        <div className="mainGrid"> 
            ...
            <nav className="navbar navbar-expand-lg">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <a className="my-2 my-sm-0 mr-4" href="/login.html"><svg className="icono-nav"
                    ...
                    <a className="my-2 my-sm-0" href="/registro.html"><svg className="icono-nav" xmlns="http://www.w3.org/2000/svg"
